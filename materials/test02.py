...
#         global finalTime
#         # finalTime=t
#         finalTime = str(int(t / 60000)) + ":" + str(int((t) / 1000 % 60))
...
#                 anxiety_count) + "  " + "Alive time:" + str(int(t / 60000)) +
#             ":" + str(int((t) / 1000 % 60)),
#             True, self.fontColor, self.backgroudColor)  # 配置要显示的文字
...
#     def attack(self):
#         if self.life > 0:
#             bullet = PlayerBullet_RedBullet(self.x, self.y)
#             player_bullets.append(bullet)
#
#     def attack_2(self):
#         if self.life > 0:
#             bullet = PlayerBullet_BigBlueball(self.x, self.y)
#             player_bullets.append(bullet)
#
#
# # 玩家子弹类
# class PlayerBullet_RedBullet(GameObject):
...
#
# # 玩家小技能
# class PlayerBullet_BigBlueball(GameObject):
#     def __init__(self, x, y):
#         super().__init__()
#         self.x = x
...
#     # 随机生成BOSS
#     # enemyRefresh_time = 200
#     enemyRefresh_time = 2000  # BOSS 的刷新时间
#     if time_count % enemyRefresh_time == 0:
#         boss = Boss()  # 创建一个BOSS
...
# # 初始化方法
# def init():
#     global screen, background, player
